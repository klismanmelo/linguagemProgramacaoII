...
public class Exercicio01 {
    public static void main(String[] args) {
        Pais p1 = new Pais("BRA", "BRASIL", 232323.23, 100000);
        Pais p2 = new Pais("ARG", "ARGENTINA", 2323.23, 2548161);
        Pais p3 = new Pais("URU", "URUGUAI", 2323.23, 451186);
        Pais p4 = new Pais("EQU", "EQUADOR", 2323.23, 65222555);
        Pais p5 = new Pais("BOL", "BOLÍVIA", 2323.23, 7894165);
